...
$env:PSDIFY_TEST_ACCESS_TOKEN = ""  # DO NOT USE PRODUCTION ACCOUNT. ALL APPS AND DATASETS WILL BE DELETED DURING TESTING
$env:PSDIFY_TEST_CSRF_TOKEN = ""  # DO NOT USE PRODUCTION ACCOUNT. ALL APPS AND DATASETS WILL BE DELETED DURING TESTING
